...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = array())
    {
        ...
        if (substr(PHP_OS, 0, 3) != WIN) {
            ...
            if ($max != 0 && $timeout > $max) { // Dont bother if unlimited
    ...
    public function authenticate(
        ...
        // SMTP extensions are available. Lets try to find a proper authentication method
     ...
     * Dont use this function without first trying to use QUIT.
     * @see quit()
     * @access public
     * @return void
     */
     ...
     * Used to keep keep-alives alive, doesnt actually do anything
     * @access public
     * @return boolean
     */
     ...
     *  - null returned: handshake was not or we dont know about ext (refer to $this->error)
    ...
    /**
     * Read the SMTP servers response.
     * Either before eof or socket timeout occurs on the operation.
     * With SMTP we can tell if we have more lines to read if the
     * 4th character is - symbol. If it is a space then we dont
