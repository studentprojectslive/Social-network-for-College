...
class HTML2PDF_myPdf extends TCPDF
{
        ...
        $cornerBR=null)
    {
        ...
        if ($x!==null && $y!==null && $w!==null && $h!==null) {
            // the positions of the rectangles corners
            $x1 = $x*$this->k;
            $y1 = ($this->h-$y)*$this->k;
    ...
    /**
     * we redifine the original SetX method, because we dont want the automatic treatment.
    ...
    /**
     * we redifine the original SetY method, because we dont want the automatic treatment.
     * It is HTML2PDF that make the treatment
     *
     * @param float   $y
    ...
    /**
     * we redifine the original SetXY method, because we dont want the automatic treatment.
     * It is HTML2PDF that make the treatment
     *
     * @param integer $x
     * @param integer $y
